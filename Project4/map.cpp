...
{
	float endx = min((int)(player.getPosition().x / Gridsizef + 11), (int)maxSize.x), endy = min((int)(player.getPosition().y / Gridsizef +10), (int)maxSize.y);
	for (int i = max((int)(player.getPosition().x/Gridsizef-10), 0); i < endx; i++)
	{
